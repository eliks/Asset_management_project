...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            ...
            <h3>Add Maintenance Activity</h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="x_panel">
                ...
                <form class="form-horizontal form-label-left" action="{{route('maintenance.update', $maintenance->id) }}" method="POST">
                    {{method_field('PATCH')}}
                    {{csrf_field()}}
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="description" value="{{old('description')?old('description'):$maintenance->description}}" placeholder="Describe activity performed on asset">
                        @error ('description')
                            <span class="invalid-feedback text-danger" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="maintained_by" value="{{old('maintained_by')?old('maintained_by'):$maintenance->maintained_by}}" placeholder="Enter name of technician">
                        @error ('maintained_by')
                            <span class="invalid-feedback text-danger" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="supervised_by" value="{{old('supervised_by')?old('supervised_by'):$maintenance->supervised_by}}" placeholder="Enter name of supervisor">
                        @error ('supervised_by')
                            <span class="invalid-feedback text-danger" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" name="location" value="{{old('location')?old('location'):$maintenance->location}}" placeholder="Enter where asset was maintained">
                        @error ('location')
                            <span class="invalid-feedback text-danger" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
