...
<div class="right_col" role="main">
    <div class="">
        <div class="page-title">
            ...
            <h3>Add New Asset <small>Asset registration via opened link</small></h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="x_panel">
                ...
                @endif
                <form class="form-horizontal form-label-left" action="{{route ('assets.store_via_closed_link', ['token'=>$link_token])}}" method="POST">
                  {{csrf_field()}}
                   <div class="box-body">
