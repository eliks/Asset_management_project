            ...
            <div class="x_panel">
                ...
                <form class="form-horizontal form-label-left" action="{{route('assets.update', $asset->id) }}" method="POST">
                  ...
                  {{csrf_field()}}
                   <div class="box-body">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="name" class="form-control" placeholder="Enter Asset's name..." value="{{$asset->name}}">
                         @error('name')
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="form-control" name="type_id">
                            @foreach(\App\AssetType::all() as $asset_type)
                                <option value="{{$asset_type->id}}" {{$asset_type->id == $asset->type_id? "selected":""}}>{{$asset_type->name}}</option>
                            @endforeach
                        </select>
                        @error('type_id')
                            <span class="invalid-feedback text-danger" role="alert">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="form-control" name="location_id">
                             @foreach(\App\Location::all()->sortBy('name') as $location)
                                <option value="{{$asset->location_id}}">{{$location->name}}</option>
                            @endforeach
                        </select>
                        @error('location_id')
                            <span class="invalid-feedback text-danger" role="alert">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" name="brand" class="form-control" placeholder="Enter Asset's brand..." value="{{$asset->brand}}">
                         @error('brand')
                        <span class="invalid-feedback text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                         <select class="form-control" name="user_name">
                             @foreach(\App\User::all()->sortBy('username') as $user)
                                <option value="{{$user->user_name}}">{{$user->username}}</option>
                            @endforeach
                        </select>
                         @error('user_name')
                        <span class="invalid-feedback text-danger" role="alert">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="date" name="date_commenced"class="form-control" value="{{$asset->date_commenced}}">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="date" name="date_acquired"  class="form-control" id="autocomplete-custom-append" placeholder="date acquired" value="{{$asset->date_acquired}}">
                         @error('date_acquired')
                        <span class="invalid-feedback text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
